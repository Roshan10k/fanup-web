    ...
    <nav className="bg-white shadow-lg sticky top-0 z-50">
      <div className="flex items-center justify-between px-10 py-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="text-base font-medium text-gray-800 hover:text-black transition-colors">
            Login
          </Link>
          <Link
            href="/signup"
            className="bg-red-500 text-white text-base font-medium px-6 py-2 rounded-full hover:bg-red-600 transition"
          >
            Sign Up
          </Link>
        </div>
